...
app.config["SECRET_KEY"] = "nonpaycompayrollminerva"
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://trial_1ubv_user:bgUlmHwqX8MTM2kJuDT6VkvqqLAQDLFg@dpg-cntau8un7f5s73f81650-a.oregon-postgres.render.com/trial_1ubv'
